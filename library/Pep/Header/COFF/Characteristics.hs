...
hasCharacteristic IMAGE_FILE_BYTES_REVERSED_LO       (Characteristics flags) = testBit flags  7
hasCharacteristic IMAGE_FILE_32BIT_MACHINE           (Characteristics flags) = testBit flags  8
hasCharacteristic IMAGE_FILE_DEBUG_STRIPPED          (Characteristics flags) = testBit flags  9
hasCharacteristic IMAGE_FILE_REMOVABLE_RUN_FROM_SWAP (Characteristics flags) = testBit flags 10
hasCharacteristic IMAGE_FILE_NET_RUN_FROM_SWAP       (Characteristics flags) = testBit flags 11
hasCharacteristic IMAGE_FILE_SYSTEM                  (Characteristics flags) = testBit flags 12
hasCharacteristic IMAGE_FILE_DLL                     (Characteristics flags) = testBit flags 13
hasCharacteristic IMAGE_FILE_UP_SYSTEM_ONLY          (Characteristics flags) = testBit flags 14
hasCharacteristic IMAGE_FILE_BYTES_REVERSED_HI       (Characteristics flags) = testBit flags 15
